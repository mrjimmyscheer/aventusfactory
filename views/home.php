<main>
  ...
  <div class="grid place-items-center sm:grid-cols-2 lg:grid-cols-3 gap-y-20 gap-x-6" style="margin-bottom: 300px;">
    <?php for ($y = 0; $y <= 2; $y++): ?>
  ...
  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 place-items-center">
    <?php for ($x = 0; $x <= 7; $x++): ?>
    <div class="card mb-4">
      <img src="assets/images/kevin_smit.jpg" alt="Kevin" style="width: 200px; height: 250px;">
      <p class="font-bold mt-2">John Doe</p>
